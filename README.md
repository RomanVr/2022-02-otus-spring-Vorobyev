...
- [9. CRUD приложение с Web UI и хранением данных в БД](#9)
---
...
### <a id="9" />  CRUD приложение с Web UI и хранением данных в БД

- #### Описание: Разработать полноценные классические Web-приложения
- Требования:
