...
public class GenreDaoJdbc implements GenreDao {
    ...
    public Genre getById(long id) {
        ...
        return namedJdbc.queryForObject(
                "SELECT id, genreTitle " +
                        "FROM Genre WHERE id = :id", params, new GenreMapper());
    }
    ...
    public Genre getByTitle(String genreTitle) {
        ...
        return namedJdbc.queryForObject(
                "SELECT id, genreTitle " +
                        "FROM Genre WHERE genreTitle = :genreTitle", params, new GenreMapper());
    }
    ...
    public long insert(Genre genre) {
        ...
        namedJdbc.update(
                "INSERT INTO Genre (genreTitle) VALUES (:genreTitle)", parameters, keyHolder, new String[]{"ID"});
    ...
    public List<Genre> getAll() {
        return namedJdbc.query("SELECT id, genreTitle FROM Genre", new GenreMapper());
    }
